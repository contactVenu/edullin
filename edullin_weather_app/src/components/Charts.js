    ...
    return (<>
        ...
        <div className="my-3 d-flex justify-content-around">
            <div className="d-flex flex-column align-items-center">
                ...
                <span className="h6">{`${getMaxValue('forecast_Temperature')}°C`}</span>
            </div>
            <div className="d-flex flex-column align-items-center">
                <span className="small">Max Forecast Rain</span>
                <span className="h6">{`${getMaxValue('forecast_Rain')}mm`}</span>
            </div>
            <div className="d-flex flex-column align-items-center">
                <span className="small">Max Historical Temperature</span>
                <span className="h6">{`${getMaxValue('temperature_History')}°C`}</span>
            </div>
            <div className="d-flex flex-column align-items-center">
                <span className="small">Max Historical Rain</span>
                <span className="h6">{`${getMaxValue('rain_History')}mm`}</span>
            </div>
        </div>
